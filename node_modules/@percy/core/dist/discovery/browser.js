...
class Browser extends _events.default {
  ...
  async launch({
    ...
    if (executable && !(0, _fs.existsSync)(executable)) {
    ...
    for (let a of uargs) if (!args.includes(a)) args.push(a); // spawn the browser process detached in its own group and session
    ...
    this.ws = new _ws.default(await this.address(timeout), {
